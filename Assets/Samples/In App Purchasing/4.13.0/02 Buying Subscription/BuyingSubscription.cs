...
namespace Samples.Purchasing.Core.BuyingSubscription
{
    public class BuyingSubscription : MonoBehaviour, IDetailedStoreListener
    {
        ...
        // Инициализация настроек магазина 
        void InitializePurchasing()
        {
            var builder = ConfigurationBuilder.Instance(StandardPurchasingModule.Instance());

            // Добовление вип товара в магазин 
        ...
        // срабатывает обратный вызов об успешной инициализации 
        ...
        // срабатывает обратный вызов об ошибке инициализации 
